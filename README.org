...
I gave a talk at several Clojure user groups (Belgium, Spain, Israel). BeClojure did a great job at recording it and making it available on Youtube. @MattiasBuelens also produced a very nice [[http://mattiasbuelens.github.io/interactiveprogrammingtalk/interactiveprogramming.html][interactive UI]] for the BeClojure talk.

#+HTML: <iframe width="560" height="315" src="https://www.youtube.com/embed/50vU6rp2jyA" frameborder="0" allowfullscreen></iframe>
