...
** Example project
An example project is available under the examples folder. It is a self-contained project that will help you get started. You can select the example project with a [[http://leiningen.org/][Leinigen]] toolchain or a [[http://boot-clj.com/][Boot]] toolchain.
** Usage
