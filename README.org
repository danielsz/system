...
** License
Distributed under the [[http://opensource.org/licenses/eclipse-1.0.php][Eclipse Public License]] (the same as Clojure) together with the [[https://github.com/996icu/996.ICU/blob/master/LICENSE][966.icu]] license.
