...
- System map is accessed directly (project for beginners). https://github.com/danielsz/system-advanced-example
...
#+BEGIN_SRC clojure
(ns user
  (:require [system.repl :refer [system init start stop reset]]
