...
** Credits
I wish to thank Stuart Sierra for his guidance. Special thanks to James Reeves for the ~reloaded.repl~ library and general inspiration. Thanks to Peter Taoussanis, the friendly OSS contributor, who helped to ‘componentize’ Sente, an amazing library on its own right.
