...
There is also a convenience macro ~defsystem~ that allows you to write the above more succinctly:
...
#+END_SRC
*Note:* Component allows you to define dependency relationships within systems. Don’t use the above macro for those cases. Be sure to consult component’s API to see the range of options available to you.
