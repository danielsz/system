...
- [[https://github.com/mmcgrana/ring][Jett]]y (HTTP server)
- [[http://http-kit.org/][HTTP kit]] (Async HTTP server)
- [[http://www.datomic.com/][Datomi]]c (Immutable database)
- [[http://clojuremongodb.info/][Monge]]r (MongoDB client)
- [[https://github.com/ptaoussanis/sente][Sent]]e (Websockets/Ajax communications library)
- [[https://github.com/clojure/tools.nrepl][nREP]]L (Clojure network REPL )
- [[http://clojurerabbitmq.info/][Langoh]]r (RabbitMQ client)
