...
- Everybdoy is welcome to participate in the discussion around the upcoming changes: https://github.com/danielsz/system/issues/48
- Completely revised the reloading mechanism. Logic was greatly simplified.
- Leveraging tools.namespace renders obsolete the hot-reloading option (and also the files option). #’refresh does the right thing. 
** 0.2.1-SNAPSHOT
